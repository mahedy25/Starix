  ...
  useGSAP(() => {
    ...
    if (window.scrollY < 20) {
      introTl
        ...
        .from(can1GroupRef.current.rotation, { z: 3, x: 1 }, 0)
        .from(can2GroupRef.current.position, { y: 5, x: 1 }, 0)
        .from(can2GroupRef.current.rotation, { z: 3, x: 1 }, 0)
    }
    ...
    scrollTl
      ...
      .to(can1Ref.current.position, { x: -0.25, y: -0.7, z: -2 }, 0)
      .to(can1Ref.current.rotation, { z: 0.3 }, 0)

      //Can 2
      .to(can2Ref.current.position, { x: 0.8, y: -0.2, z: -1 }, 0)
